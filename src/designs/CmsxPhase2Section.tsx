...
import { CaseStudySection } from '../components/SoftAppear';
import {
...
function LaptopShowcase({
  ...
  return (
    <div className="relative flex min-h-[280px] w-full shrink-0 items-center justify-center overflow-hidden rounded-[24px] bg-[#e3dfd6] py-8 sm:min-h-[417px]">
...
export function CmsxPhase2Section({ docUrl, nextProject }: Props) {
  return (
    <>
      ...
      >
        <div className="content-stretch flex flex-col gap-8 items-start relative shrink-0 w-full sm:gap-12" data-node-id="818:354">
      ...
      <div className="border-[#ddd8d0] border-solid border-t h-px shrink-0 w-full" data-node-id="818:569" />
      ...
      >
        <div className="content-stretch flex flex-col gap-6 items-start relative shrink-0 w-full">
          ...
          <div className="flex flex-col font-['DM_Sans:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#6b6b6b] text-[16px] w-full whitespace-pre-wrap" style={{ fontVariationSettings: "'opsz' 14" }}>
      ...
      <div className="border-[#ddd8d0] border-solid border-t h-px shrink-0 w-full" data-node-id="818:389" />
      ...
      >
        ...
        <div className="flex flex-col font-['DM_Sans:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#6b6b6b] text-[16px] w-full" style={{ fontVariationSettings: "'opsz' 14" }}>
          <p className="leading-[25.5px]">
        ...
        <div className="flex w-full flex-wrap items-center gap-x-2 gap-y-3" data-node-id="818:400">
          {PROCESS_STEPS.map((step, index) => (
            <div key={step.label} className="flex items-center gap-2">
              {index > 0 ? (
                <span className="font-['DM_Sans:Regular',sans-serif] text-[#6b6560] text-[14px] leading-[22.4px]" style={{ fontVariationSettings: "'opsz' 14" }}>
                  →
                </span>
              ) : null}
              <span
        ...
        <div className="content-stretch relative flex h-auto w-full shrink-0 flex-col items-stretch gap-6 font-['DM_Sans:SemiBold',sans-serif] font-semibold sm:flex-row sm:gap-8" data-node-id="818:423">
          {ITERATION_DECISIONS.map((text, index) => (
            <div key={text} className="content-stretch flex min-h-px min-w-0 flex-[1_1_0] flex-col items-start gap-3 self-stretch">
              <div className="flex flex-col justify-center leading-[0] relative shrink-0 text-[#6b6b6b] text-[14px] whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 14" }}>
                <p className="leading-[21px]">{String(index + 1).padStart(2, '0')}</p>
              </div>
              <p className="leading-[28px] min-w-0 w-full relative shrink-0 text-[#432060] text-[16px] whitespace-normal break-words" style={{ fontVariationSettings: "'opsz' 14" }}>
                {text}
              </p>
            </div>
          ))}
      ...
      <div className="border-[#ddd8d0] border-solid border-t h-px shrink-0 w-full" data-node-id="818:433" />
      ...
      >
        ...
        <div className="content-stretch flex flex-col gap-5 items-start relative shrink-0 w-full" data-node-id="818:445">
            ...
            >
              ...
              <div className="content-stretch flex flex-[1_0_0] flex-col gap-4 items-start min-w-px relative w-full">
                <div className="content-stretch flex flex-col gap-2 items-start relative shrink-0 w-full">
                  <div className="flex flex-col font-['DM_Sans:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#1c1c1c] text-[15px] w-full" style={{ fontVariationSettings: "'opsz' 14" }}>
                ...
                {finding.dualImage ? (
                  <div className="flex w-full flex-col gap-4 sm:flex-row sm:items-start">
                    <div className="relative aspect-[341/411] w-full shrink-0 overflow-hidden rounded-[2px] border border-solid border-[#e8dfd0] sm:max-w-[228px]">
                      <img alt="" className="absolute left-0 top-[0.08%] h-[99.92%] max-w-none w-[224.05%]" src={imgPhase2Finding3Tooltip} />
                    </div>
                  ...
                  <div className={`relative overflow-hidden rounded-[2px] border border-solid border-[#e8dfd0] ${finding.imageClassName}`}>
      ...
      <div className="border-[#ddd8d0] border-solid border-t h-px shrink-0 w-full" data-node-id="818:495" />
      ...
      <div className="border-[#ddd8d0] border-solid border-t h-px shrink-0 w-full" data-node-id="818:517" />
      ...
      >
        ...
        <div className="content-stretch flex flex-col gap-3 items-start relative shrink-0 w-full" data-node-id="818:526">
          {PHASE2_REFLECTIONS.map((item) => (
            ...
            >
              <div className="bg-[#ede7f8] content-stretch flex items-center justify-center pb-[5.84px] pt-[4.16px] relative rounded-[10px] shrink-0 size-[40px]">
                <p className="font-['DM_Sans:Regular',sans-serif] text-[22px] leading-[37.4px]" style={{ fontVariationSettings: "'opsz' 14" }}>
                  {item.emoji}
                </p>
              </div>
              <div className="flex flex-col font-['DM_Sans:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#2a2a2a] text-[14px] w-full" style={{ fontVariationSettings: "'opsz' 14" }}>
      ...
      <div className="border-[#ddd8d0] border-solid border-t h-px shrink-0 w-full" data-node-id="818:549" />

      <div className="content-stretch flex flex-col items-center pt-10 relative shrink-0 w-full" data-node-id="818:550">
        <a
          href={docUrl}
          target="_blank"
          rel="noopener noreferrer"
      ...
      <div className="content-stretch flex flex-wrap gap-3 items-center justify-end pt-24 pb-16 relative shrink-0 w-full" data-node-id="818:553">
        <div className="flex flex-col font-['DM_Sans:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#6b6b6b] text-[14px] whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 14" }}>
        ...
        >
          <div className="capitalize flex flex-col font-['DM_Sans:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#4a2472] text-[14px] tracking-[0.52px]" style={{ fontVariationSettings: "'opsz' 14" }}>
